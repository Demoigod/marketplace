import{a as l,i as v,g as m,s as o}from"./navbar-CpVXx8h8.js";/* empty css               */let n=null;document.addEventListener("DOMContentLoaded",async()=>{if(await l(),!await v()){window.location.href="index.html";return}n=await m(),n&&(await i(),u())});async function i(){const e=document.getElementById("conversationsContainer");e.innerHTML='<div class="loading-state">Loading your messages...</div>';try{const{data:a,error:r}=await o.from("conversations").select("*").or(`user1_id.eq.${n.id},user2_id.eq.${n.id}`).order("created_at",{ascending:!1});if(r)throw r;if(!a||a.length===0){e.innerHTML=`
