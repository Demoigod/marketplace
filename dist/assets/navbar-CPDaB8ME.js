import{g as h,b as f}from"./auth-B4SlU3WG.js";async function b(){y(),await k()}function y(){const o=document.querySelector(".menu-toggle"),t=document.querySelector(".nav-links");o&&t&&(o.onclick=()=>{t.classList.toggle("active"),o.textContent=t.classList.contains("active")?"✕":"☰"})}async function k(){const o=document.querySelector(".nav-content");if(!o)return;const t=await h(),s=!!t,l='<svg class="menu-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="3" y1="12" x2="21" y2="12"></line><line x1="3" y1="6" x2="21" y2="6"></line><line x1="3" y1="18" x2="21" y2="18"></line></svg>',r='<svg class="menu-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>',c=`
    ...
    `,w()}function w(){document.querySelectorAll(".dropdown-container").forEach(e=>{const n=e.querySelector(".icon-btn"),a=e.querySelector(".dropdown-menu-modern");!n||!a||(n.addEventListener("click",v=>{v.stopPropagation();const g=e.classList.contains("open");p(),g||(e.classList.add("open"),n.setAttribute("aria-expanded","true"),n.classList.add("active"))}),n.addEventListener("keydown",v=>{v.key==="Escape"&&(p(),n.focus())}))}),document.addEventListener("click",e=>{e.target.closest(".dropdown-container")||p()});const t=async()=>{await f(),window.location.href="index.html"},s=document.getElementById("menuLogout");s&&s.addEventListener("click",t);const l=document.getElementById("navLogout");l&&l.addEventListener("click",t);const r=e=>{e.preventDefault(),window.location.pathname.endsWith("index.html")||window.location.pathname.endsWith("/")?document.dispatchEvent(new CustomEvent("open-post-modal")):window.location.href="index.html?action=post"},c=document.getElementById("menuPostItem");c&&c.addEventListener("click",r);const i=document.getElementById("navPostItem");i&&i.addEventListener("click",r);const d=document.getElementById("navLoginBtn");d&&d.addEventListener("click",e=>{var a;e.preventDefault();const n=document.getElementById("authModal");n&&((a=document.querySelector('.auth-tab[data-tab="login"]'))==null||a.click(),n.classList.add("active"))});const u=document.getElementById("navSignupBtn");u&&u.addEventListener("click",e=>{var a;e.preventDefault();const n=document.getElementById("authModal");n&&((a=document.querySelector('.auth-tab[data-tab="register"]'))==null||a.click(),n.classList.add("active"))});const m=document.getElementById("navSearchInput");m&&m.addEventListener("keypress",e=>{e.key==="Enter"&&(document.getElementById("marketplaceGrid")||(window.location.href=`index.html?search=${encodeURIComponent(e.target.value)}`))})}function p(){document.querySelectorAll(".dropdown-container").forEach(o=>{o.classList.remove("open");const t=o.querySelector(".icon-btn");t&&(t.setAttribute("aria-expanded","false"),t.classList.remove("active"))})}export{b as i};
