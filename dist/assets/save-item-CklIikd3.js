import{s as r,i as c,g as l}from"./auth-DlafXHy2.js";async function v(){try{const{data:e,error:t}=await r.from("market_listings").select(`
                *,
                profiles:seller_id (
                    username,
                    full_name
                )
            `).eq("status","active").order("created_at",{ascending:!1});if(t)throw t;return e||[]}catch(e){return console.error("Error fetching items:",e),[]}}function f(e,t=!1){var o,d;const s=new Date(e.created_at).toLocaleDateString();let a=e.image_url;!a&&e.images&&e.images.length>0&&(a=e.images[0]),a||(a="https://via.placeholder.com/300x200?text=No+Image");let i="";return t?i=`
        ...
        <div class="marketplace-item" data-id="${e.id}" data-user-id="${e.seller_id}">
            ...
            <div class="item-content">
                ...
                <div class="item-meta" style="margin-bottom: 0.5rem; font-size: 0.85rem; color: #666;">
                    <span>By ${n(((o=e.profiles)==null?void 0:o.username)||((d=e.profiles)==null?void 0:d.full_name)||"Anonymous")}</span>
                </div>
